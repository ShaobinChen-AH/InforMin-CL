...
def main():
    ...
    if data_args.train_file is not None:
        data_files["train"] = data_args.train_file # data/wiki1m_for_simcse.txt
    ...
    # Prepare features
    column_names = datasets["train"].column_names #['text']
    ...
    if training_args.do_train: #True
        ...
        train_dataset = datasets["train"].map( # datasets["train"] class 'datasets.arrow_dataset.Dataset'
            prepare_features,
            batched=True,
